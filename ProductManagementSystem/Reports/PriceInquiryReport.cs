...
{
    public partial class PriceInquiryReport : Form
    {
        ...
        public int PrInId;
        public PriceInquiryReport()
        {
            InitializeComponent();
        }

        private void PriceInquiryReport_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                string ct = "SELECT PrInId FROM PriceInquiry ORDER BY PrInId";
